 ...
 * https://www.jiuzhang.com/solutions/boggle-game
 */
public class BoggleGame_new {
    ...
    public static void main(String[] argus){
        char[][] board = new char[][]{{'d','o','g'},
                                    {'c','a','t'},
                                    {'c','a','p'}};
        String[] words = new String[]{"dog","cat","dccap","ogt","cap"};

        char[][] board_1 = new char[][]{{'a','a','a'},
                {'a','a','a'}};
        String[] words_1 = new String[]{"aaa","aa","aaaa"};

        BoggleGame_new bgn = new BoggleGame_new();
        bgn.getAllWords(board, words);
    }
}
